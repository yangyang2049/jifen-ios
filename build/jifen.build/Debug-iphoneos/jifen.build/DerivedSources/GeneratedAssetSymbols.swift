...
extension DeveloperToolsSupport.ImageResource {
    ...
    static let shareCardAppIcon = DeveloperToolsSupport.ImageResource(name: "ShareCardAppIcon", bundle: resourceBundle)
...
extension AppKit.NSImage {
    ...
    /// The "ShareCardAppIcon" asset catalog image.
    static var shareCardAppIcon: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .shareCardAppIcon)
#else
        .init()
#endif
    }
...
extension UIKit.UIImage {
    ...
    /// The "ShareCardAppIcon" asset catalog image.
    static var shareCardAppIcon: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: .shareCardAppIcon)
#else
        .init()
